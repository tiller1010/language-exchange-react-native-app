  ...
  async componentDidMount(){
    if(this.props.route.params){
      if(this.props.route.params.keywords || this.props.route.params.sort){
        ...
        if(this.props.route.params.languageOfTopic){
          this.setState({
            languageOfTopic: this.props.route.params.languageOfTopic
          }, () => {
            this.handleSearch(`${process.env.APP_SERVER_URL}/videos.json?keywords=${this.state.keywords}&sort=${this.state.sort}&languageOfTopic=${this.state.languageOfTopic}`);
          });
        }
        return;
      }
