...
export default class VideoSearchForm extends React.Component {
  ...
  handleSortChange(value){
    this.setState({
      ...
      this.props.navigation.navigate('Videos', { ...this.state })
    });
  }
    ...
    return(
      <View>
        <Searchbar type="text" placeholder="Search" onChangeText={(text) => this.setState({keywords: text})} value={this.state.keywords}
          ...
          onIconPress={() => this.props.navigation.navigate('Videos', { ...this.state })}
          onSubmitEditing={() => this.props.navigation.navigate('Videos', { ...this.state })}
        />
